...
<div
  ...
  style="width: calc(20rem + 2px + 0.75rem + 0.5rem)"
>
  <div
  ...
  >
    {#each headings as heading}
      <a
        ...
        style={`width: calc(15rem - ${heading.depth - 2} * 1rem); max-width: calc(15rem - ${heading.depth - 2} * 1rem); padding-left: calc(${heading.depth - 2} * 1rem);`}

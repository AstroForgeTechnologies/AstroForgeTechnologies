<script lang="ts">
  ...
  import { Project, Studio } from "@threlte/theatre";
  import HeroScene from "@components/HeroScene.svelte";
  import state from "@assets/data/AST.theatre-project-state.json";
...
<div class="grid grid-cols-1 overflow-hidden rounded-3xl">
